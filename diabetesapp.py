...
DiabetesPedigreeFunction = st.number_input('DiabetesPedigreeFunction', min_value=0.000, max_value=2.000, value=0.000, step=0.001, format="%.3f")
BMI = st.number_input('BMI', min_value=0.0, max_value=150.0, value=20.0, step=0.1, format="%.1f")
